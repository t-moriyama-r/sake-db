...
export type Category = {
  ...
  createUserId?: Maybe<Scalars['ID']['output']>;
  ...
  updateUserId?: Maybe<Scalars['ID']['output']>;
  updateUserName?: Maybe<Scalars['String']['output']>;
...
export type QuerySearchLiquorsArgs = {
...
export type GetMyDataFullQueryVariables = Exact<{ [key: string]: never }>;

export type GetMyDataFullQuery = {
  __typename: 'Query';
  getMyData: {
    __typename: 'User';
    id: string;
...
export type AuthUserDataFragmentFragment = {
  __typename: 'User';
  id: string;
  name: string;
  imageBase64?: string | null;
...
export type GetBookMarkedListQuery = {
  __typename: 'Query';
  getBookMarkedList?: Array<{
    __typename: 'BookMarkListUser';
    userId: string;
    name: string;
    imageBase64?: string | null;
...
export type GetIsBookMarkedQuery = {
  __typename: 'Query';
...
export type RandomRecommendListQuery = {
  __typename: 'Query';
  randomRecommendList: Array<{
    __typename: 'Liquor';
    id: string;
    name: string;
    categoryId: number;
...
export type GetRecommendLiquorListQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetRecommendLiquorListQuery = {
  __typename: 'Query';
  getRecommendLiquorList: Array<{
    __typename: 'Recommend';
    rate: number;
    comment: string;
    updatedAt: any;
...
export type PostFlavorMutation = {
  __typename: 'Mutation';
  postFlavor: boolean;
};
...
export type GetVotedQuery = {
  __typename: 'Query';
  getVoted?: { __typename: 'VotedData'; x: any; y: any } | null;
};
...
export type ListFromCategoryQuery = {
  __typename: 'Query';
  listFromCategory: {
    __typename: 'ListFromCategory';
    categoryName: string;
...
export type LiquorHistoriesQuery = {
  __typename: 'Query';
  liquorHistories?: {
    __typename: 'LiquorHistory';
    now: {
...
export type SearchLiquorsQueryVariables = Exact<{
  keyword: Scalars['String']['input'];
  limit?: InputMaybe<Scalars['Int']['input']>;
}>;


export type SearchLiquorsQuery = { __typename: 'Query', searchLiquors: Array<{ __typename: 'Liquor', id: string, name: string, categoryId: number, categoryName: string, description?: string | null, imageBase64?: string | null, updatedAt: any }> };
...
export type GetTagsQuery = {
  __typename: 'Query';
  getTags: Array<{ __typename: 'Tag'; id: string; text: string }>;
};
...
export type PostTagMutation = {
  __typename: 'Mutation';
  postTag: { __typename: 'Tag'; id: string; text: string };
};
...
export type GetUserByIdDetailQuery = {
  __typename: 'Query';
  getUserByIdDetail: {
    __typename: 'UserPageData';
    evaluateList: {
...
<<<<<<< HEAD
export const AuthUserDataFragmentFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'AuthUserDataFragment' },
      typeCondition: {
        kind: 'NamedType',
...
} as unknown as DocumentNode<AuthUserDataFragmentFragment, unknown>;
export const AuthPayloadFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
...
} as unknown as DocumentNode<AuthPayloadFragment, unknown>;
export const AdminCheckDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'adminCheck' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          { kind: 'Field', name: { kind: 'Name', value: 'checkAdmin' } },
        ],
      },
    },
  ],
} as unknown as DocumentNode<AdminCheckQuery, AdminCheckQueryVariables>;
...
export const GetMyDataFullDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getMyDataFull' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'getMyData' },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<GetMyDataFullQuery, GetMyDataFullQueryVariables>;
export const ResetEmailDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'resetEmail' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
...
} as unknown as DocumentNode<ResetEmailMutation, ResetEmailMutationVariables>;
...
} as unknown as DocumentNode<ResetExeMutation, ResetExeMutationVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'loginWithRefreshToken' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
export const GetBookMarkListDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getBookMarkList' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
  ...
  GetBookMarkListQueryVariables
>;
export const GetBookMarkedListDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getBookMarkedList' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
  ...
  GetBookMarkedListQuery,
  GetBookMarkedListQueryVariables
>;
export const GetIsBookMarkedDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getIsBookMarked' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<AddBookMarkMutation, AddBookMarkMutationVariables>;
...
export const HistoriesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'imageBase64' },
                      },
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'versionNo' },
                      },
                      {
                        kind: 'Field',
...
} as unknown as DocumentNode<HistoriesQuery, HistoriesQueryVariables>;
export const RandomRecommendListDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'RandomRecommendList' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  RandomRecommendListQuery,
  RandomRecommendListQueryVariables
>;
export const GetRecommendLiquorListDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getRecommendLiquorList' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
  ...
  GetRecommendLiquorListQuery,
  GetRecommendLiquorListQueryVariables
>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'postBoard' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
...
} as unknown as DocumentNode<PostBoardMutation, PostBoardMutationVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getMyBoard' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<GetMyBoardQuery, GetMyBoardQueryVariables>;
...
export const GetFlavorMapDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getFlavorMap' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'categoryId' } },
                { kind: 'Field', name: { kind: 'Name', value: 'xNames' } },
                { kind: 'Field', name: { kind: 'Name', value: 'yNames' } },
                {
                  kind: 'Field',
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'userAmount' },
                      },
                      {
                        kind: 'Field',
...
} as unknown as DocumentNode<GetFlavorMapQuery, GetFlavorMapQueryVariables>;
export const PostFlavorDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'postFlavor' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'PostFlavorMap' },
            },
          },
        },
      ],
...
} as unknown as DocumentNode<PostFlavorMutation, PostFlavorMutationVariables>;
export const GetVotedDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getVoted' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
...
} as unknown as DocumentNode<GetVotedQuery, GetVotedQueryVariables>;
export const LiquorDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
} as unknown as DocumentNode<LiquorQuery, LiquorQueryVariables>;
export const ListFromCategoryDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'listFromCategory' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
  ...
  ListFromCategoryQuery,
  ListFromCategoryQueryVariables
>;
export const LiquorHistoriesDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'liquorHistories' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
  ...
  LiquorHistoriesQuery,
  LiquorHistoriesQueryVariables
>;
...
export const PostTagDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'postTag' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
...
} as unknown as DocumentNode<PostTagMutation, PostTagMutationVariables>;
...
export const GetUserByIdDetailDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getUserByIdDetail' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'evaluateList' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'recentComments' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            {
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'rate5Liquors' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            {
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'rate4Liquors' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            {
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'rate3Liquors' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            {
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'rate2Liquors' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            {
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'rate1Liquors' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            {
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'noRateLiquors' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            {
  ...
  GetUserByIdDetailQuery,
  GetUserByIdDetailQueryVariables
>;
=======
...
export const AuthPayloadFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AuthPayload"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"AuthPayload"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"accessToken"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"AuthUserDataFragment"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AuthUserDataFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"User"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"imageBase64"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}}]} as unknown as DocumentNode<AuthPayloadFragment, unknown>;
...
export const RegisterUserDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"registerUser"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"RegisterInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"registerUser"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"AuthPayload"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AuthUserDataFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"User"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"imageBase64"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AuthPayload"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"AuthPayload"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"accessToken"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"AuthUserDataFragment"}}]}}]}}]} as unknown as DocumentNode<RegisterUserMutation, RegisterUserMutationVariables>;
export const LoginDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"login"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"LoginInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"login"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"AuthPayload"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AuthUserDataFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"User"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"imageBase64"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AuthPayload"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"AuthPayload"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"accessToken"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"AuthUserDataFragment"}}]}}]}}]} as unknown as DocumentNode<LoginMutation, LoginMutationVariables>;
export const GetMyDataFullDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getMyDataFull"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getMyData"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"profile"}},{"kind":"Field","name":{"kind":"Name","value":"imageBase64"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}}]}}]} as unknown as DocumentNode<GetMyDataFullQuery, GetMyDataFullQueryVariables>;
...
export const ResetExeDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"resetExe"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"token"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"password"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"resetExe"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"token"},"value":{"kind":"Variable","name":{"kind":"Name","value":"token"}}},{"kind":"Argument","name":{"kind":"Name","value":"password"},"value":{"kind":"Variable","name":{"kind":"Name","value":"password"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"AuthPayload"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AuthUserDataFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"User"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"imageBase64"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AuthPayload"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"AuthPayload"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"accessToken"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"AuthUserDataFragment"}}]}}]}}]} as unknown as DocumentNode<ResetExeMutation, ResetExeMutationVariables>;
export const RefreshTokenDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RefreshToken"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"refreshToken"}}]}}]} as unknown as DocumentNode<RefreshTokenMutation, RefreshTokenMutationVariables>;
export const LoginWithRefreshTokenDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"loginWithRefreshToken"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"loginWithRefreshToken"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"AuthPayload"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AuthUserDataFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"User"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"imageBase64"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AuthPayload"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"AuthPayload"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"accessToken"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"AuthUserDataFragment"}}]}}]}}]} as unknown as DocumentNode<LoginWithRefreshTokenMutation, LoginWithRefreshTokenMutationVariables>;
...
export const SearchLiquorsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"searchLiquors"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"keyword"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"limit"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"searchLiquors"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"keyword"},"value":{"kind":"Variable","name":{"kind":"Name","value":"keyword"}}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"categoryId"}},{"kind":"Field","name":{"kind":"Name","value":"categoryName"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"imageBase64"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]} as unknown as DocumentNode<SearchLiquorsQuery, SearchLiquorsQueryVariables>;
